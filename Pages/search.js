...
class SearchScreen extends React.Component {
 ...
 LoadingIndicatorView() {
  ...
  search=async ()=>{
    ...
    let teams = await backup.db_teams.find({$or:[{team_name_ar:patttern},{team_name_en:patttern}]}).asArray();
    res_teams = teams.map(t=>{ 
      countries[team_flag] = t.team_country;
      return {
        id         : t.team_id,
        name_ar    : t.team_name_ar,
