...
exports.styles_settings = exports.global_theme = exports.styles_league = exports.themes_list = exports.app_styles = exports.styles_match = exports.styles_channel = exports.styles_news = exports.styles_home = exports.styles_article = exports.styles_list = exports.Themes = void 0;
...
function getTheme() {
  var style_name = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
  //var API_ = new API();
  return API_.getConfig("theme", Global_theme_name).then(function (theme_name__) {
...
exports.themes_list = themes_list;
...
function generateTheme() {
  ...
  var styles_list = {
    ...
    columnWrapperStyle2: {
      justifyContent: 'flex-end' //paddingRight: __isMobile ? 10 : 20
  ...
  var styles_home = {
    ...
    title: {
      ...
      fontWeight: 'bold',
      textAlign: 'center',
      color: theme.home_title_color //fontFamily : "cairoregular",
  ...
  var styles_article = _reactNative.StyleSheet.create({
    ...
    article_v: {
      ...
      padding: 5,
      fontSize: 18,
      backgroundColor: theme.background_color_default //backgroundColor: '#8e5858',
  ...
  var styles_news = _reactNative.StyleSheet.create({
    container: {
      flex: 1,
      //paddingTop: Constants.statusBarHeight,
      backgroundColor: theme.background_color_default,
  ...
  var styles_channel = _reactNative.StyleSheet.create({
    container_scrl: {
    ...
    info_cont: {
      ...
      padding: 5,
      fontSize: 18,
      color: theme.text_color_default //backgroundColor: theme.background_color_default,
  ...
  var styles_match = _reactNative.StyleSheet.create({
    container: {
      flex: 1,
      paddingTop: 3,
      backgroundColor: theme.background_color_default,
  ...
  var styles_league = _reactNative.StyleSheet.create({
    container: {
      flex: 1,
      width: "100%",
      alignContent: "center",
  ...
  var app_styles = {
    ...
    tabBarOptions: {
      ...
      size: 30,
      swipeEnabled: true,
      showLabel: true //labelPosition:"below-icon",
      //tabStyle:{color:"red"}
  ...
  var styles_settings = _reactNative.StyleSheet.create({
    container: {
      flex: 1,
      //paddingTop: Constants.statusBarHeight,
      backgroundColor: theme.background_color_default,
    ...
    modal_view_container: {
      ...
      width: "100%",
      height: "100%",
      paddingTop: 22 //backgroundColor:"red"
  ...
  return {
    ...
    styles_article: styles_article,
    styles_home: styles_home,
    styles_news: styles_news,
    styles_channel: styles_channel,
